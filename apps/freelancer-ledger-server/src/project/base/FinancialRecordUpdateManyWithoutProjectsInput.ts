...
@InputType()
class FinancialRecordUpdateManyWithoutProjectsInput {
...
export { FinancialRecordUpdateManyWithoutProjectsInput as FinancialRecordUpdateManyWithoutProjectsInput };
