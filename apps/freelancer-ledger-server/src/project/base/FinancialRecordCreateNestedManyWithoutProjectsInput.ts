...
@InputType()
class FinancialRecordCreateNestedManyWithoutProjectsInput {
...
export { FinancialRecordCreateNestedManyWithoutProjectsInput as FinancialRecordCreateNestedManyWithoutProjectsInput };
